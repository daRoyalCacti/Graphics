...
void copyBuffer(VkDevice device, VkCommandPool commandPool, VkQueue graphicsQueue, VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    ...
    //validation layers have buffer size error checking
...
VkShaderModule createShaderModule(VkDevice device, const std::vector<char>& code) {
  //Before shader code can be passed to the pipeline it must be wrapped in a VkShaderModule object
  //This is a helper function that does this
...
const char* indentifyDevice(VkPhysicalDeviceType type) {
	...
	throw std::runtime_error("inavlid device type");
